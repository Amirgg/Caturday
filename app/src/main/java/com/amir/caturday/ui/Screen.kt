...
sealed class Screen(val route: String) {
    ...
    data object FavoritesList : Screen("favorites-list")
    data object Settings : Screen("settings")
    data object BreedsDetails : Screen("breeds-details?$ARG_ID={$ARG_ID}") {
        fun getId(navBackStackEntry: NavBackStackEntry): String? {
            return navBackStackEntry.arguments?.getString(ARG_ID)
        }
